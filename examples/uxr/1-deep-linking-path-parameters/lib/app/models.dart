...
Section? fromSectionName(String? name) =>
    name
        ?.trim()
        .isNotEmpty == true
        ? Section.values.firstWhereOrNull((section) =>
...
SectionTab? fromSectionTabName(String? name) =>
    name
        ?.trim()
        .isNotEmpty == true
        ? SectionTab.values.firstWhereOrNull((tab) =>
    sectionTabName(tab) == name)
        : null;
